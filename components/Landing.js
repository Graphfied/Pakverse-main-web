    ...
    <section>
      <div className="max-w-3xl mx-8 md:mx-auto">
        <div className="my-20 space-y-10 text-center sm:my-16 md:space-y-14">
          ...
          <AnimatedText>
            <h1 className="text-3xl font-semibold text-white sm:text-5xl md:text-6xl md:text-white">
              Welcome to Pakverse.
            </h1>
            </AnimatedText>
            <h2 className="text-lg text-black md:text-2xl md:mx-10 md:text-white">
               Pioneering the AI-Driven Future of Startups
          ...
          <div className="transition duration-500 ease-in-out transform scale-100 translate-x-0 translate-y-0 opacity-100">
            <div className="space-y-2">
              <a
                ...
                className="px-5 py-2 font-semibold text-gray-200 duration-500 ease-in-out shadow-lg hover:-translate-y-1.5 rounded-2xl md:text-xl md:px-8 md:py-3 bg-gradient-to-br to-green-600 from-blue-500 hover:bg-gradient-to-br hover:to-blue-500 hover:from-purple-600"
              >
                Get Quote{' '}
                <svg
              ...
              <div className="pt-4 text-sm text-black sm:pt-2 md:text-white">
                Best And Fast Response
                <br />
