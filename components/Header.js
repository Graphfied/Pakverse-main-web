    ...
    <header>
      <div className="flex flex-col px-4 pt-4 mx-auto text-white roboto-regular max-w-7xl md:mx-10 lg:mx-20 xl:mx-auto md:flex-row md:items-center md:justify-between">
        <div className="flex flex-row items-center justify-between p-4">
          <a
            href="/"
            className="text-4xl font-semibold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-red-300 to-amber-300 md:text-white"
          >
            Pakverse
          </a>
          <button
        ...
        >
          <div className="flex-col pl-4 text-xl md:flex-grow md:pl-0">
            <ul className="flex flex-wrap items-center justify-end flex-grow gap-2 pr-4 space-x-2 md:gap-6 md:space-x-6">
              ...
              <li>
                <a
                  href="https://pakverse-join-beta.vercel.app/"
                  className="bg-white rounded-full bg-opacity-40 px-4 text-lg text-white md:text-white shadow-sm transition-colors duration-75 group gap-[0.25em] inline-flex items-center py-1.5 hover:cursor-pointer hover:bg-opacity-90"
                >
                  Join Waitlist
                  <svg
                    viewBox="0 0 16 16"
